...
var _INIT_CODE_HASH_MAP, _FACTORY_ADDRESS_MAP, _ROUTER_ADDRESS_MAP, _SOLIDITY_TYPE_MAXIMA;
var WADZCHAIN_CHAIN_ID = 171717;
/** NOTE: Wadz-specific */
var ChainId;
(function (ChainId) {
  ...
  ChainId[ChainId["WADZCHAIN_MAINNET"] = WADZCHAIN_CHAIN_ID] = "WADZCHAIN_MAINNET";
  ChainId[ChainId["BNB"] = 56] = "BNB";
})(ChainId || (ChainId = {}));
var WADZCHAIN_WWCO_ADDRESS = '0x2996F51be16a9ee9A0a867f7518D55908F6B44CA';
var BNB_WBNB_ADDRESS = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
var TradeType;
(function (TradeType) {
...
/** NOTE: Wadz-specific */
var INIT_CODE_HASH = '0xef8ef663d992dea71acf872a41c6c344699e481f62330c39dae2be4102890f7a';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.BNB] = '0xef8ef663d992dea71acf872a41c6c344699e481f62330c39dae2be4102890f7a', _INIT_CODE_HASH_MAP[ChainId.MAINNET] = '0xef8ef663d992dea71acf872a41c6c344699e481f62330c39dae2be4102890f7a', _INIT_CODE_HASH_MAP[ChainId.WADZCHAIN_MAINNET] = '0xef8ef663d992dea71acf872a41c6c344699e481f62330c39dae2be4102890f7a', _INIT_CODE_HASH_MAP);
var getInitCodeHash = function getInitCodeHash(chainId) {
  return INIT_CODE_HASH_MAP[chainId] || INIT_CODE_HASH;
};
var FACTORY_ADDRESS = '0x9A9bed06107B0036361DE7320042918c029EDB78';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.BNB] = '0x2996F51be16a9ee9A0a867f7518D55908F6B44CA', _FACTORY_ADDRESS_MAP[ChainId.MAINNET] = '0x65166A8f9C8bC43fA0647F088FCDb9B044C9F48D', _FACTORY_ADDRESS_MAP[ChainId.WADZCHAIN_MAINNET] = '0x9A9bed06107B0036361DE7320042918c029EDB78', _FACTORY_ADDRESS_MAP);
var getFactoryAddress = function getFactoryAddress(chainId) {
  return FACTORY_ADDRESS_MAP[chainId] || FACTORY_ADDRESS;
};
var ROUTER_ADDRESS = '0xdbA784B3A27a5dBFCa0739eD3E8EFdea2bF8F663';
var ROUTER_ADDRESS_MAP = (_ROUTER_ADDRESS_MAP = {}, _ROUTER_ADDRESS_MAP[ChainId.BNB] = '0x65166A8f9C8bC43fA0647F088FCDb9B044C9F48D', _ROUTER_ADDRESS_MAP[ChainId.MAINNET] = '0xaD2DD426639fE954f6c47f55758CCF9AFC535BE0', _ROUTER_ADDRESS_MAP[ChainId.WADZCHAIN_MAINNET] = '0xdbA784B3A27a5dBFCa0739eD3E8EFdea2bF8F663', _ROUTER_ADDRESS_MAP);
var getRouterAddress = function getRouterAddress(chainId) {
...
Currency.WCO = /*#__PURE__*/new Currency(18, 'WCO', 'WCO');
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'WLP-V2', 'WLP V2');
    this.tokenAmounts = tokenAmounts;
  }
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    var _PAIR_ADDRESS_CACHE, _PAIR_ADDRESS_CACHE$t;
    var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks
    var INIT_CODE_HASH = getInitCodeHash(tokenA.chainId);
    var FACTORY_ADDRESS = getFactoryAddress(tokenA.chainId);
