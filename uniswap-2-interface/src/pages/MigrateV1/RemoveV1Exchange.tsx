...
import { useV1ExchangeContract } from '../../hooks/bridge/useContract'
...
import { getCurrencySymbol, getNativeTokenSymbol, getWrappedNativeTokenSymbol } from '../../utils/getNativeTokenSymbol'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${
            chainId && token.equals(WETH[chainId])
              ? getWrappedNativeTokenSymbol(chainId)
              : getCurrencySymbol(token, chainId)
          }/${getNativeTokenSymbol(chainId)} V1 liquidity`
        })
